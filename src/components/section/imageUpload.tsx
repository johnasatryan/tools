...
import descriptionImg from '../../assets/images/uploadPage/cropimage.svg';
import GoogleDrive from './googleDrivePicker';
...
export const ImageUpload: NextPage = () => {
  ...
  return (
    <article className='fileupload-container'>
      <div className='fileupload-wrapper'>
        ...
        <div className='fileupload-top'>
          <div className='fileupload-top-icon'>
            <Image src={descriptionImg} alt='descriptionImg' />
          </div>
          <div className='fileupload-top-description'>
            <h2 className='heading-primary u-margin-bottom-m'>
